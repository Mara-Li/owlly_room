...
class controlleur(
    ...
    @commands.command(
        aliases=["edit_desc"],
        brief="Edition de la description",
        help="Permet à un auteur de modifier la description de son channel.",
        usage="description du channel",
        description="La commande doit être faite sur le channel que l'on souhaite modifier.",
    )
    ...
    @commands.command(
        usage="id du message à unpin",
        brief="Désépingle un message",
        help="Permet de désépingler un message.",
    )
    ...
    @commands.command(
        aliases=["pin"],
        help="Permet d'épingler un message sur le channel",
        usage="id du message à épingler",
        brief="Epingle un message.",
    )
    ...
    @commands.command(
        aliases=["name"],
        usage="nouveau nom",
        brief="Renomme un channel",
        help="Permet de changer le nom d'un channel, même un ticket, tant que vous êtes l'auteur. Attention, la commande doit-être faite dans le channel que vous souhaitez modifier.",
    )
